...
class PascalZeroShot(object):
    ...
    def __init__(self, split, n_unseen, image_size=224) -> None:
        ...
        from ldm.data.third_party.JoEm.data_loader.dataset import VOCSegmentation
        from ldm.data.third_party.JoEm.data_loader import get_seen_idx, get_unseen_idx, VOC
